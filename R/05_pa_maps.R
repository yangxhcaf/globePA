...
colnames(r_pa) <- c("x", "y", "I-II", "III-IV", "V-VI", "Non-designated", "All")
...
ggsave(paste0("figures/maps_perc_prot.png"), p, width=5.8, height=9, dpi=600)
